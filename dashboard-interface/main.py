...
async def engines_status():
    ...
    engines = [
        {"id": 1, "name": "Login & Register", "port": settings.LOGIN_REGISTER_ENGINE_PORT, "path": "login-register-engine"},
        ...
        {"id": 5, "name": "Processed Metadata Store", "port": settings.PROCESSED_METADATA_STORE_PORT, "path": "processed-user-metadata-store"},
        {"id": 6, "name": "Vector Database", "port": settings.VECTOR_DATABASE_PORT, "path": "vector-database"},
        {"id": 7, "name": "Neural Network", "port": settings.NEURAL_NETWORK_ENGINE_PORT, "path": "neural-network-engine"},
        {"id": 8, "name": "Anomaly Detection", "port": settings.ANOMALY_DETECTION_ENGINE_PORT, "path": "anomaly-detection-engine"},
        ...
        {"id": 11, "name": "Policy Fetching", "port": settings.POLICY_FETCHING_ENGINE_PORT, "path": "policy-fetching-engine"},
        {"id": 12, "name": "JSON User Info Gen", "port": settings.JSON_USER_INFO_GENERATOR_PORT, "path": "json-user-info-generator"},
        {"id": 13, "name": "Analytics Warehouse", "port": settings.ANALYTICS_WAREHOUSE_PORT, "path": "analytics-warehouse"},
        {"id": 14, "name": "Dashboard Interface", "port": settings.DASHBOARD_INTERFACE_PORT, "path": "dashboard-interface"},
        {"id": 15, "name": "Eligibility Rules", "port": settings.ELIGIBILITY_RULES_ENGINE_PORT, "path": "eligibility-rules-engine"},
        {"id": 16, "name": "Deadline Monitoring", "port": settings.DEADLINE_MONITORING_ENGINE_PORT, "path": "deadline-monitoring-engine"},
        {"id": 17, "name": "Simulation Engine", "port": settings.SIMULATION_ENGINE_PORT, "path": "simulation-engine"},
        {"id": 18, "name": "Gov Data Sync", "port": settings.GOVERNMENT_DATA_SYNC_ENGINE_PORT, "path": "government-data-sync-engine"},
        {"id": 19, "name": "Trust Scoring", "port": settings.TRUST_SCORING_ENGINE_PORT, "path": "trust-scoring-engine"},
        {"id": 20, "name": "Speech Interface", "port": settings.SPEECH_INTERFACE_ENGINE_PORT, "path": "speech-interface-engine"},
        {"id": 21, "name": "Document Understanding", "port": settings.DOCUMENT_UNDERSTANDING_ENGINE_PORT, "path": "document-understanding-engine"},
    ]
